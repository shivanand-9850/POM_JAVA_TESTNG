...
public class LogingTL_page {
	...
	@FindBy(xpath="//span[text()=' MT Intern 2   ']") WebElement sorter;
...
// // Log out user
	...
	WebElement save2;
	@FindBy(xpath = "//mat-select[@formcontrolname=\"physician\"]")
	...
	WebElement save91;
	@FindBy(xpath = "(//div[@class='mat-form-field-infix ng-tns-c62-10'])[1]")
	WebElement Status;
...
//	@FindBy(xpath = "//span[text()='Update']")
//	WebElement Update;
	@FindBy(xpath = "//mat-select[@formcontrolname='workitemId']")WebElement workitemId;
	@FindBy(xpath = "//span[text()='Add']")WebElement Add;
	@FindBy(xpath = "//input[@formcontrolname='employeeName']")
	...
	public void CreateNew_WorkItem() {
		...
		File f = new File(projectDirectory + "\\TestData\\Upload_File.pdf");
		...
		Time_sleep();
		subaction.moveToElement(Eidit_Icon).perform();
		js.executeScript("arguments[0].click()", Eidit_Icon);
		Priority.click();
		Super_Stat.click();
		check_circle.click();
		Time_sleep();
		...
		subaction.moveToElement(Patient).perform();
		js.executeScript("arguments[0].click()", Patient);
		Patient.sendKeys("Asitis");
		Time_sleep();
		Ssubaction.moveToElement(Sub_ClientName_First).perform();
		js.executeScript("arguments[0].click()", Sub_ClientName_First);
		Time_sleep();
		Ssubaction.moveToElement(check_circle).perform();
		js.executeScript("arguments[0].click()", check_circle);
		Time_sleep();
		Time_sleep();
		Ssubaction.moveToElement(Chack_Box).perform();
		js.executeScript("arguments[0].click()", Chack_Box);
		Time_sleep();
		Ssubaction.moveToElement(Create_Job).perform();
		js.executeScript("arguments[0].click()", Create_Job);
		Time_sleep();
...
//		option.click();
	...
	public void Add_workItem() 
	{
		...
		driver.navigate().refresh();
		BC = new BaseClass();
		Ssubaction.moveToElement(Altos_Icon).perform();
		js.executeScript("arguments[0].click()", Altos_Icon);
		Ssubaction.moveToElement(Jobs_Page).perform();
		js.executeScript("arguments[0].click()", Jobs_Page);
		...
		Ssubaction.moveToElement(Add2).perform();
		js.executeScript("arguments[0].click()", Add2);
		//CommonUtility.moveToElement(driver, Add2);
		//Add2.click();
		Time_sleep();
		driver.navigate().refresh();
		Time_sleep();
		CommonUtility.performClickAction(driver, Add2);
		Time_sleep();
		Check_Box2.click();
		Time_sleep();
		Add_WorkItems.click();
...
//		}
	...
	public void Assing_NEW_ROR() {
		...
		Time_sleep();
		option.click();
		Ssubaction.moveToElement(Update).perform();
		JavascriptExecutor js = (JavascriptExecutor) driver;
...
//		}
	...
	public void WorkItem_Page_job_Task() {
		...
		Time_sleep();
		Actions Ssubaction = new Actions(driver);
		Ssubaction.moveToElement(JobType).perform();
		...
		CommonUtility.jsClick(driver, workitemId);
		Ssubaction.moveToElement(option).perform();
		js.executeScript("arguments[0].click()", option);
		CommonUtility.jsClick(driver, Member);
		Member.sendKeys("MT Intern 2");
		Ssubaction.moveToElement(check_circle).perform();
		js.executeScript("arguments[0].click()", check_circle);
//		Ssubaction.moveToElement(option).perform();
...
//		js.executeScript("arguments[0].click()", check_circle);
		...
		Time_sleep();
		Ssubaction.moveToElement(Sorter_QA).perform();
		js.executeScript("arguments[0].click()", Sorter_QA);
		Time_sleep();
		...
		Time_sleep();
		Ssubaction.moveToElement(MT).perform();
		js.executeScript("arguments[0].click()", MT);
		Time_sleep();
		AddMember.click();
		Member.sendKeys("MT 2");
		String e = "MT 2";
		...
		Time_sleep();
		Ssubaction.moveToElement(MT2assign).perform();
		js.executeScript("arguments[0].click()", MT2assign);
		Time_sleep();
		AddMember.click();
		...
		Time_sleep();
		Ssubaction.moveToElement(QA).perform();
		...
		Time_sleep();
		Ssubaction.moveToElement(QC).perform();
		js.executeScript("arguments[0].click()", QC);
		Time_sleep();
		AddMember.click();
		Member.sendKeys("QC 1");
		Time_sleep();
...
//Client Template
	public void Uplode_client_Template() {
		...
		Time_sleep();
		Report_Structure_Template.click();
		Time_sleep();
		...
		js.executeScript("arguments[0].click()", templateType);
		Time_sleep();
		CommonUtility.jsClick(driver, Tagged_Document_Template);
		Time_sleep();
	...
	public void Filter_allfield_workitempage() {
		...
		CommonUtility.jsClick(driver, DownArrow1);
		CommonUtility.findAndClickElementByKeyword(Dropdown_Element1, "pdf");
		CommonUtility.jsClick(driver, DownArrow2);
	...
	public void Filter_allfield_jobPage() {
		...
		try {
			for (WebElement Employee_select : Employee_name) {
				...
				if (J1.equalsIgnoreCase(b)) {
					...
					clselect.moveToElement(Employee_select).perform();
					Time_sleep();
					subaction.moveToElement(Employee_select).perform();
					js.executeScript("arguments[0].click()", Employee_select);
					//CommonUtility.jsClick(driver, Employee_select);
					Time_sleep();
					break;
		...
		subaction.moveToElement(select_clint).perform();
		js.executeScript("arguments[0].click()", select_clint);
		//CommonUtility.jsClick(driver, select_clint);
		Time_sleep();
		subaction.moveToElement(Job_patient_name).perform();
		js.executeScript("arguments[0].click()", Job_patient_name);
		...
		subaction.moveToElement(Dropdown_button_job).perform();
		js.executeScript("arguments[0].click()", Dropdown_button_job);
		CommonUtility.findAndClickElementByKeyword(Dropdown_Element1,"ROR");
		Time_sleep();
		subaction.moveToElement(Job_priority_downarrow).perform();
		js.executeScript("arguments[0].click()", Job_priority_downarrow);
		//CommonUtility.jsClick(driver, Job_priority_downarrow);
		CommonUtility.findAndClickElementByKeyword(Priroty_dropdown,"Super Stat");
		Time_sleep();
		subaction.moveToElement(Job_status_downarrow).perform();
		js.executeScript("arguments[0].click()", Job_status_downarrow);
		...
		Time_sleep();
		Time_sleep();
		subaction.moveToElement(expand_more).perform();
		js.executeScript("arguments[0].click()", expand_more);
		//CommonUtility.jsClick(driver, expand_more);
		Time_sleep();
		subaction.moveToElement(expand_less).perform();
		js.executeScript("arguments[0].click()", expand_less);
	...
	public void Merge_workitem() {
		...
		checkbox.click();
		checkbox1.click();
		CommonUtility.jsClick(driver, Merge_button);
		Time_sleep();
		CommonUtility.jsClick(driver, Merge_WorkItem);
		Time_sleep();
		CommonUtility.jsClick(driver, Yes2_button);
		Time_sleep();
		driver.navigate().refresh();
		CommonUtility.jsClick(driver, Undo_button);
		Time_sleep();
		CommonUtility.jsClick(driver, Yes2_button);
		Time_sleep();
		Assert.assertTrue(true);
	...
	public void Split_workitem() {
		...
		CommonUtility.jsClick(driver, add1_button);
		Time_sleep();
